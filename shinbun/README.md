...
世の中のニュースは、claude.ai の「設定 → コネクタ」で **Parallel Search**（無料・登録不要）を追加しておくと、
AIが Web で調べてから深掘りして書きます（「Webで調べる」を「しない」にすると、メモに書いたことだけで書きます）。
調べた情報源は一覧で出るので、配る前に大事な数字や日付を確かめてください。「トップ記事」を「世の中のニュース」にすると、深掘り記事を大きくのせられます。
